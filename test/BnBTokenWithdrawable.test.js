...
describe("BnBToken Test", () => {
  ...
  it("Deploy Staking Pool(Withdrawable)", async () => {
    ...
    const intrestSymbol = await withdrawablePool.intrestSymbol();
  ...
  it("Initialize Pool", async () => {
    ...
    await token.connect(operator).approve(withdrawablePool.address, INTEREST_AMOUNT);
    ...
    const contractTokenBalance = await token.balanceOf(withdrawablePool.address);
    const intrestTotal = await withdrawablePool.intrestTotal();
  ...
  it("First Calculate", async () => {
    ...
    const staker1Intrest = await withdrawablePool.intrestOf(staker1.address);
    const staker2Intrest = await withdrawablePool.intrestOf(staker2.address);
    const staker3Intrest = await withdrawablePool.intrestOf(staker3.address);
    const intrestRest = await withdrawablePool.intrestRest();
  ...
  it("Must can withdraw", async() => {
    ...
    await expect(withdrawablePool.connect(staker1).principalWithdraw(staker1Balance.toString())).to.be.reverted;
    await expect(withdrawablePool.connect(staker1).interestWithdraw(staker1Intrest.toString())).to.be.reverted;
  });
  ...
  it("Second Calculate", async () => {
    ...
    const staker1Intrest = await withdrawablePool.dayInterestOf(staker1.address, 2);
    const staker2Intrest = await withdrawablePool.dayInterestOf(staker2.address, 2);
    const staker3Intrest = await withdrawablePool.dayInterestOf(staker3.address, 2);
    const intrestRest = await withdrawablePool.intrestRest();
  ...
  it("Third Calculate", async () => {
    ...
    const staker1Intrest = await withdrawablePool.dayInterestOf(staker1.address, 3);
    const staker2Intrest = await withdrawablePool.dayInterestOf(staker2.address, 3);
    const staker3Intrest = await withdrawablePool.dayInterestOf(staker3.address, 3);
    const intrestRest = await withdrawablePool.intrestRest();
  ...
  it("Check First Staker Calculate", async () => {
    const day1Intrest = await withdrawablePool.dayInterestOf(staker1.address, 1);
    const day2Intrest = await withdrawablePool.dayInterestOf(staker1.address, 2);
    const day3Intrest = await withdrawablePool.dayInterestOf(staker1.address, 3);
    ...
    const totalIntrest = await withdrawablePool.intrestOf(staker1.address);
  ...
  it("Check Second Staker Calculate", async () => {
    const day1Intrest = await withdrawablePool.dayInterestOf(staker2.address, 1);
    const day2Intrest = await withdrawablePool.dayInterestOf(staker2.address, 2);
    const day3Intrest = await withdrawablePool.dayInterestOf(staker2.address, 3);
    ...
    const totalIntrest = await withdrawablePool.intrestOf(staker2.address);
    const totalManualCalc = day1Calc.add(day2Calc).add(day3Calc);
    const totalCalc = day1Intrest.add(day2Intrest).add(day3Intrest);
  ...
  it("Check Third Staker Calculate", async () => {
    const day1Intrest = await withdrawablePool.dayInterestOf(staker3.address, 1);
    const day2Intrest = await withdrawablePool.dayInterestOf(staker3.address, 2);
    const day3Intrest = await withdrawablePool.dayInterestOf(staker3.address, 3);
    ...
    const totalIntrest = await withdrawablePool.intrestOf(staker3.address);
    const totalManualCalc = day1Calc.add(day2Calc).add(day3Calc);
    const totalCalc = day1Intrest.add(day2Intrest).add(day3Intrest);
  ...
  it("First Staker Withdraw", async () => {
    ...
    await withdrawablePool.connect(staker1).interestWithdraw(staker1Intrest.toString());
    ...
    const afterIntrestBalance = await withdrawablePool.intrestOf(staker1.address);
  ...
  it("Second Staker Withdraw", async () => {
    ...
    await withdrawablePool.connect(staker2).interestWithdraw(staker2Intrest.toString());
    ...
    const afterIntrestBalance = await withdrawablePool.intrestOf(staker2.address);
  ...
  it("Third Staker Withdraw", async () => {
    ...
    await withdrawablePool.connect(staker3).interestWithdraw(staker3Intrest.toString());
    ...
    const afterIntrestBalance = await withdrawablePool.intrestOf(staker3.address);
